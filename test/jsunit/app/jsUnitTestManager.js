...
jsUnitTestManager.prototype._finishTestFunction = function(excep, timeBefore) {
  ...
  var newOption = this.testCaseResultsField.ownerDocument.createElement("option");
  newOption.setAttribute('value', serializedTestCaseString);  
...
function isBeingRunOverHTTP() {
  var dp = getDocumentProtocol();
  return dp=="http://" || dp=="https://";
}   
